...
const kickingSteps = [
    {
        ...
        description: (
            <>
                응급처치 자세 유지하기 - 상체와 하체를 일직선으로 유지하며 처치 동작 준비
            </>
        ),
    ...
    },
    {
        ...
        description: (
            <>
                수평 유지, 좌우 균형 조절 - 처치 동작 및 이동 기술 연습
            </>
        ),
        ...
        <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-8">
            ...
            <div className="bg-kua-gray100 flex w-full items-center gap-4 rounded-[10px] p-4 text-lg">
                <div className="relative h-[25px] w-[25px]">
                    <Image src="/imgs/icons/warning.svg" alt="응급처치" fill />
                </div>
                <div>
                    초보자는 전문 교육 기관에서 체계적인 교육을 받아야 합니다.
                    <br />
                    항상 안전 규칙을 준수하고 응급처치 절차를 지켜야 합니다.
                </div>
            </div>
        </div>
    );
