...
const koreaHistoryData = [
    {
        year: "1980년대",
        content: "한국 응급처치 협회 설립, 응급처치 교육 보급 시작",
    },
    {
        year: "1990년대",
        content: "전국 응급처치 클럽 증가, 체계적인 교육 시스템 도입",
    },
    {
        year: "2000년대",
        content: "안전 교육 강화, 전국 각 지역 응급처치 센터 증가",
    },
    {
        year: "2010년대 이후",
        content: "응급처치 교육 확대, 국제 응급처치 기관과의 협력",
    },
];
