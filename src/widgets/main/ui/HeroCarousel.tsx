...
export const HeroCarousel = () => {
    ...
    return (
        ...
        >
            ...
            />
            <div className="text-kua-white relative flex min-h-[80%] min-w-4/5 flex-col items-start justify-end gap-4 pb-[14%] text-[1em]">
                <div className="text-[2em]">{slides[currentSlide].title}</div>
