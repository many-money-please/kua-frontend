...
const koreaHistoryData = [
    {
        year: "1960년대",
        content: "한국스킨스쿠버다이빙클럽 창설, 스쿠버다이빙 보급 시작",
    },
    {
        year: "1980년대",
        content: "전국 다이빙 협회 설립, 체계적인 교육 시스템 도입",
    },
    {
        year: "1990년대",
        content: "레저 스포츠로 대중화, 전국 각 지역 다이빙 센터 증가",
    },
    {
        year: "2000년대 이후",
        content: "안전 교육 강화, 국제 인증 교육 기관과의 협력",
    },
];
        ...
        <div className="bg-kua-sky50 flex w-full flex-col gap-16 py-24">
            <div className="mx-auto w-full max-w-[1200px]">
                ...
                <p className="text-kua-gray600 text-2xl leading-relaxed">
                    스쿠버다이빙은 1960년대 한국에 도입되어
                    <br /> 오늘날 안전하고 즐거운 수중 레저 스포츠로 발전했습니다.
                </p>
            </div>
